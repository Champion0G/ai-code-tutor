  ...
  return (
    <div className="flex flex-col items-center justify-center min-h-screen bg-background p-4">
      <div className="w-full max-w-6xl mx-auto">
        <header className="flex flex-col sm:flex-row justify-between items-center mb-12 sm:mb-8">
            <div></div>
            <div className="order-first sm:order-last mb-4 sm:mb-0">
            {!isLoaded ? (
        ...
        <div className="text-center">
            ...
            <p className="text-lg md:text-xl text-muted-foreground mb-12 max-w-2xl text-center mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
            ...
            <CardHeader>
                ...
                <CardTitle className="text-2xl font-headline">Universal AI Tutor</CardTitle>
                </div>
                <CardDescription>
